...
<head>
    ...
    <title>Agregar Tipo de cuotas</title>
</head>
<body>
	<main>
		<div class="container my-5 p-4">
			<div class="row mt-3">
				<div class="col">
					<form action="procesos/guardarCuota.php" method="POST">
						<div class="row">
						...
						<div class="row">
							<div class="col-12 col-md-6 mb-3">
								...
								<input type="text" class="form-control" placeholder="TIPO CUOTA" name="descripcion" required>
							</div>
						</div>
						<div class="row">
