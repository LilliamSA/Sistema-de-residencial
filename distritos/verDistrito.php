					...
					<tbody>
						...
						require('../connect.php');
							...
							while($fila=oci_fetch_array($stid,OCI_ASSOC)){
								print "<tr>
								    <td>".$fila['ID_DISTRITO']."</td>
									<td>".$fila['N_DIS']."</td>
									<td><a href='actualizarDistrito.php?id=".$fila['ID_DISTRITO']."'>Actualizar</a></td>
									<td><a href='eliminarDistrito.php?id=".$fila['ID_DISTRITO']."'>Eliminar</a></td>
