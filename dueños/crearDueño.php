...
<body>
	<main>
		<div class="container my-5 p-4">
			<div class="row mt-3">
				<div class="col">
					<form action="procesos/guardarDueño.php" method="POST">
						<div class="row">
							<div class="col-12 col-md-6 mb-3">
								<label for="id" class="form-label">Cédula</label>
								<input type="text" class="form-control" placeholder="INGRESE EL NUMERO DE CEDULA" name="id" required>
							</div>
						</div>
						<div class="row">
						    <div class="col-12 col-md-6 mb-3">
					...
					<div class="row">
							<div class="col-12 col-md-6 mb-3">
								...
								<input type="text" class="form-control" placeholder="ENCARGADO" name="nombre">
							</div>
						</div>
					<div class="row">
							<div class="col-12 col-md-6 mb-3">
								<label for="ape1" class="form-label">Primer Apellido</label>
								<input type="text" class="form-control" placeholder="APELLIDO1" name="ape1">
							</div>
						</div>
						<div class="row">
							<div class="col-12 col-md-6 mb-3">
								<label for="ape2" class="form-label">Segundo Apellido</label>
								<input type="text" class="form-control" placeholder="APELLIDO2" name="ape2">
							</div>
						</div>
						<div class="row">
