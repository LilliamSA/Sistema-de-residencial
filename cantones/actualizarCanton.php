			...
			<div class="col">
	        	...
	        	$query="SELECT * FROM CANTON WHERE ID_CANTON=$id";
                    ...
                    $fila=oci_fetch_array($stid,OCI_ASSOC);
						...
						print' <form action="procesos/editCanton.php" method="POST">
                                <div class="row">
                                    <div class="col-12 col-md-6 mb-3">
                                       <label for="id" class="form-label">Cedula</label>
                                       <input type="text" class="form-control"  name="id" value="'.$fila['ID_CANTON'].'">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 col-md-6 mb-3">
                                        <label for="distrito" class="form-label">Nombre</label>
                                        <input type="text" class="form-control" name="distrito" value="'.$fila['N_CANTON'].'">
                                    </div>
                                </div>
                                <div class="row">
